...
//   }
//   else{
//     axios.put(`http://localhost:8800/api/users/${user._id}/follow` ,{userId:currentUser._id});
...
//           </div>
//         </div>
//         <h4 className="rightbarTitle">User frienxxds</h4>
//         <div className="rightbarFollowings">
//         {friends.map((frnds)=>
//          (    
//         <Link to={`/profile/${frnds.username}`}>
//            <div className="rightbarFollowing">
//          <img
//            src={frnds.profiPicture ? PF+ frnds.profilePicture: PF+"person/noAvatar.png"}
//            alt=""
//            className="rightbarFollowingImg"
//          />
//          <span className="rightbarFollowingName">{frnds.username}</span>
//        </div>
//        </Link>
//        )
//         )}
